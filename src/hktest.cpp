...
size_t n2v(size_t n) {return (n & 7)+1;}
...
int main(int argc, char *argv[]) {
    ...
    size_t ntables = argc <= 4 ? 4: std::atoi(argv[3]);
    HeavyKeeper<32,32> hk(hksz, ntables);
