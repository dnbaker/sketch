...
FLAGS=-O3 -funroll-loops -pipe -march=native -mavx2 -Ivec -I. -fpic -Wall -Wextra -Wdisabled-optimization -Wno-unused-parameter -pedantic -fno-strict-aliasing -Wsuggest-attribute=malloc
